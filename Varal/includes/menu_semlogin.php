       ...
       <!-- <li><a href="index.php#contact">Calendário</a></li>-->
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="criar_campanha.php#visualizar">Pesquisar por Campanha</a></li>
            <li><a href="cadastrar_pessoa.php">Cadastre-se!</a></li>
            <li><a href="index.php#saibamais">Saiba mais</a></li>
          </ul>
          </li>
          <li class="active"><a href="login.php">Entrar</a></li>
         <!-- <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">Será<b class="caret"></b></a>
          <ul class="dropdown-menu">
            <li><a href="logout.php">Sair</a></li>
            <li><a href="pesquisar_campanha.php">Ver Campanhas existentes</a></li>
            <li><a href="criar_campanha.php#visualizar">Suas campanhas</a></li>
            <li><a href="visualizar_pessoa.php">Ver Perfil</a></li>
